	...
	<tbody>
		<?php foreach($versions as $key=>$version) { ?>
			<tr>
				...
				<td><a class="button" href="/games/play/<?php echo $game['Game']['id']; ?>/<?php echo strtotime($version['QuestionVersion']['created']); ?>" target="_blank">Play</a> &nbsp;<a class="button" href="/games/add_snapshot/<?php echo $game['Game']['id']; ?>/<?php echo $version['QuestionVersion']['id']; ?>" target="_blank">Create Snapshot</a></td>
			</tr>
		<?php } ?>
	</tbody>
</table>