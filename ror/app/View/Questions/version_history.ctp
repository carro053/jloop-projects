	...
	<tbody>
		<?php foreach($question['QuestionVersion'] as $key=>$version) { ?>
			<tr>
				...
				<td><?php echo date('F jS, Y',strtotime($version['created'])); ?></td>
				<td><?php echo $version['User']['username']; ?></td>
				<td><a class="button" href="/games/play_version/<?php echo $game['Game']['id']; ?>/<?php echo $version['id']; ?>" target="_blank">Play</a>&nbsp;<a class="button" href="/games/preview_version/<?php echo $game['Game']['id']; ?>/<?php echo $version['id']; ?>" target="_blank">Preview</a>
