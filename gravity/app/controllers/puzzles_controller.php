...
class PuzzlesController extends AppController {
	...
	function beforeFilter()
 	{
 		$this->Auth->allow('savePuzzle','getPuzzles','getPuzzle','getPuzzleWithSolution','saveSolution','saveImage','getPuzzleTimes','voteForPuzzle','updateAllPuzzles','viewMissionSolution','getTotalMissions');
 		parent::beforeFilter();
 	}
