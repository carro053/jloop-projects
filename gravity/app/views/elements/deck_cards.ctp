...
foreach($deck['DeckCard'] as $deck_card):
	...
	{
		if($current_card_id != 0) echo '<div><a href="" onclick="remove_card('.$current_card_id.'); return false;"><img src="/files/magic_cards/'.$current_card_id.'.jpg" /></a><br />x'.$current_card_count.'</div>';
