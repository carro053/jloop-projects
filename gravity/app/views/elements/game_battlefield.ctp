...
if($your_number == $game['MagicGame']['turn'] + 1)
{
	...
	echo '<a href="/magic/game_end_turn/'.$game['MagicGame']['id'].'" onclick="return confirm(\'Are you sure you want to end your turn?\');"><img src="/img/end_turn_button.png" height="50px" width="50px" /></a>';
