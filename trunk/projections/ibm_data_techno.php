...
$where = 'Contact.ContactID=Guid("38625e33-6eaf-4e7c-a04d-311d32becfb2") && Date>=DateTime('.$myyear.', 01, 01) && Date<=DateTime('.$enddate.') && Reference.Contains("WO") && Status != "DELETED" && Status != "VOIDED"';
//echo $where;
