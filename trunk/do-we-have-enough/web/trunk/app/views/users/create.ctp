<div class="container">
    <form action="/save_event" method="post" class="event" id="create_event" name="create_event" enctype="multipart/form-data">
        ...
        <div style="height:274px; padding-left:185px;"><input class="w8em format-d-m-y divider-dash highlight-days-67 no-fade" id="EventDate" name="data[Event][date]" type="hidden" /></div>
        <div>
