...
- (void)goPlay {
    PlayFlightSchoolMissionViewController *playFlightSchoolMissionViewController = [[PlayFlightSchoolMissionViewController alloc] initWithNibName:@"PlayFlightSchoolMissionViewController" bundle:nil withMissionId:mission_id];
    [self presentViewController:playFlightSchoolMissionViewController animated:YES completion:nil];
}
@end
