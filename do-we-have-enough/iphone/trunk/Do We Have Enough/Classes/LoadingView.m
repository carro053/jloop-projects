...
+ (id)loadingViewInView:(UIView *)aSuperview
{
	...
	//loadingLabel.textAlignment = UITextAlignmentCenter; //deprecated
...
- (void)drawRect:(CGRect)rect
{
	...
	const CGFloat RECT_PADDING = 150.0;
	const CGFloat RECT_PADDING_WIDE = 50;
	rect = CGRectInset(rect, RECT_PADDING_WIDE, RECT_PADDING);
