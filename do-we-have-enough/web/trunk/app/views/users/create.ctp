<div class="container">
    <form action="/save_event" method="post" class="event" id="create_event" name="create_event" enctype="multipart/form-data">
        ...
        <div class="indent" id="GroupNameParent" style="display:none;"><input name="data[Group][name]" id="GroupName" class="med-small" type="text" value="Name this group" onfocus="javascript:if(this.value == 'Name this group') { this.value = ''; } the_tooltip(this,'Name this group for future use. It can be used by everyone in it.','group');" onblur="javascript:if(this.value == '') { this.value = 'Name this group'; }" /></div>
