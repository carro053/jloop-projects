...
- (void)alertView:(UIAlertView *)alertView didDismissWithButtonIndex:(NSInteger)buttonIndex
{
    if(buttonIndex == 1)
    {
        ...
        [request setURL:[NSURL URLWithString:[NSString stringWithFormat:@"http://dev.gravitationsapp.com/missions/saveMission/35"]]];
...
- (void)connection:(NSURLConnection *)connection didReceiveData:(NSData *)data {
    ...
    [[EPUploader alloc] initWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"http://dev.gravitationsapp.com/missions/saveImage/%d/1",returnCode]]
                           filePath:[NSString stringWithFormat:@"%@/CustomMission_%d@2x.jpg", fileDirectory,submitMissionId]
                           delegate:self
                       doneSelector:@selector(onUploadDone:)
                      errorSelector:@selector(onUploadError:)];
    /*[[EPUploader alloc] initWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"http://dev.gravitationsapp.com/missions/saveImage/%d/0",returnCode]]
