...
- (void) viewSolutionId:(NSTimer *)timer
{
    ...
    if (_viewMissionSolutionViewController == nil) {
        self.viewMissionSolutionViewController = [[ViewMissionSolutionViewController alloc] initWithNibName:@"ViewMissionSolutionViewController" bundle:nil withMissionId:mission_id andSolutionId:theID];
    }
    [self presentViewController:_viewMissionSolutionViewController animated:YES completion:nil];
}
...
- (void)goPlay {
    if (_playMissionViewController == nil) {
        self.playMissionViewController = [[PlayMissionViewController alloc] initWithNibName:@"PlayMissionViewController" bundle:nil withMissionId:mission_id withOnline:YES];
    }
